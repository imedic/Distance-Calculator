...
public class CosineLawCalculatorTest
{
    public static IEnumerable<object[]> TestData => new List<Object[]> {
                            new object[] { new Coordinates(10, 10), new Coordinates(20,20), 6371, 1544.7575610296117 },
                            new object[] { new Coordinates(20, 20), new Coordinates(10, 10), 6371, 1544.7575610296117 },
    ...
    {
        var calculator = new CosineLawCalculator();
